...
| 参数 | 说明 | 推荐值 | 取值范围 |
|------|------|--------|----------|
| 粒子数 | 搜索粒子数量，越多搜索能力越强 | 100 | 10~100 |
| 惯性权重 w | 控制粒子运动惯性，值越大搜索范围越广 | 0.7 | 0.0~1.0 |
| 个体学习因子 c1 | 粒子向自身最优位置移动的能力 | 1.5 | 0.0~2.0 |
| 群体学习因子 c2 | 粒子向群体最优位置移动的能力 | 1.5 | 0.0~2.0 |

#### GA (遗传算法)

| 参数 | 说明 | 推荐值 | 取值范围 |
|------|------|--------|----------|
| 种群大小 | 个体数量，越多遗传多样性越好 | 50 | 10~100 |
| 进化代数 | 迭代次数，越多优化越充分 | 50 | 10~100 |
| 交叉率 | 染色体交叉产生新个体的概率 | 0.8 | 0.0~1.0 |
| 变异率 | 基因变异的概率，防止陷入局部最优 | 0.1 | 0.0~1.0 |

#### SCE-UA (洗牌复形进化)

| 参数 | 说明 | 推荐值 | 取值范围 |
|------|------|--------|----------|
| 复形数量 | 复形数量越多全局搜索能力越强 | 5 | 2~10 |
| 每复形点数 | 每个复形包含的点数 | 10 | 5~20 |

#### DE (差分进化)

| 参数 | 说明 | 推荐值 | 取值范围 |
|------|------|--------|----------|
| 变异因子 F | 变异缩放因子，控制差异向量权重 | 0.8 | 0.0~2.0 |
| 交叉概率 CR | 交叉概率，值越大交叉频率越高 | 0.7 | 0.0~1.0 |
| 种群大小 | 种群数量，越多搜索能力越强 | 50 | 10~100 |
