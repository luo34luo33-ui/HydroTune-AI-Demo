...
try:
    from leadtime_config import XGB_PARAMS, RANDOM_SEED
except ImportError:
    from xgb_error_correction.leadtime_config import XGB_PARAMS, RANDOM_SEED


class XGBCorrector(BaseCorrector):
    """XGBoost误差修正器"""
